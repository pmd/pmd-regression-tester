...
# -*- encoding: utf-8 -*-
# stub: pmdtester 1.7.1.pre.SNAPSHOT ruby lib

Gem::Specification.new do |s|
  s.name = "pmdtester".freeze
  s.version = "1.7.1.pre.SNAPSHOT".freeze
  ...
  s.extra_rdoc_files = ["History.md".freeze, "README.rdoc".freeze, "resources/js/README.md".freeze]
  ...
  s.add_runtime_dependency(%q<liquid>.freeze, ["~> 5.13".freeze])
  s.add_runtime_dependency(%q<base64>.freeze, ["~> 0.3".freeze])
  s.add_runtime_dependency(%q<bigdecimal>.freeze, ["~> 4.1".freeze])
  ...
  s.add_development_dependency(%q<mocha>.freeze, ["~> 3.1".freeze])
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.91".freeze])
  s.add_development_dependency(%q<test-unit>.freeze, ["~> 3.7".freeze])
  s.add_development_dependency(%q<rdoc>.freeze, ["~> 7.2".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 13.4".freeze])

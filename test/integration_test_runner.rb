...
class IntegrationTestRunner < Test::Unit::TestCase
  ...
  def test_local_mode
    ...
    assert_path_exist('target/reports/pmd_releases_6.1.0/checkstyle/config.xml')
    assert_path_exist('target/reports/pmd_releases_6.1.0/pmd/pmd_report.xml')
    assert_path_exist('target/reports/pmd_releases_6.1.0/pmd/config.xml')
  ...
  def test_online_mode
    ...
    assert_path_exist('target/reports/pmd_releases_6.3.0/checkstyle/config.xml')
    assert_path_exist('target/reports/pmd_releases_6.3.0/spring-framework/pmd_report.xml')
    assert_path_exist('target/reports/pmd_releases_6.3.0/spring-framework/config.xml')
    assert_path_exist('target/reports/diff/checkstyle/index.html')
